  ...
  return (
    <div className={styles.signUpPage}>
        ...
        <div className={styles.colour}>
          <div className={styles.form}>
            <div className={styles.createAccountParent}>
              ...
              <div className={styles.passwordFieldInstance}>
              ...
              <div className={styles.socialMediaLoginContainerWrapper}>
      ...
      <footer className={styles.band}>
        <div className={styles.privacyPolicyLinksContainerWrapper}>
          <div className={styles.privacyPolicyLinksContainer}>
